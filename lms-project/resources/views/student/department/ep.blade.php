    ...
    <li><a class="dropdown-item" href="{{ url('/department/ep') }}">Electrical Power</a></li>
          ...
          <li class="nav-item"><a class="nav-link {{ Request::is('events') ? 'active' : '' }}" href="{{ url('/event') }}">Events</a></li>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="#" class="btn btn-outline-secondary btn-sm">Login</a>
            ...
            <div class="row">
                ...
                <aside class="col-md-3 col-lg-2 p-0 d-none d-md-block">
                    <div class="sidebar" id="sidebar-nav">
                        <div class="sidebar-header fw-bold text-center mb-3">Electrical Power</div>
                ...
                <main class="col-md-9 col-lg-10 p-0 main-content">
                    ...
                    <section id="overview" class="hero">
                        <div class="container">
                            <h1 class="display-4 fw-bold">Electrical Power</h1>
                                        ...
                                        aria-labelledby="headingTwo">
                                         <div class="accordion-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-4">
                                                    <img src="{{asset('img/sch1.jpg')}}" alt="Computer Lab"
                                                        class="img-fluid rounded shadow">
                                                </div>
                                            </div>
                                        </div>
