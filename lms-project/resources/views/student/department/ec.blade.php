            ...
            <div class="row">
                ...
                <aside class="col-md-3 col-lg-2 p-0 d-none d-md-block">
                    <div class="sidebar" id="sidebar-nav">
                        <div class="sidebar-header fw-bold text-center mb-3">Electronics and Communication</div>
                ...
                <main class="col-md-9 col-lg-10 p-0 main-content">
                    ...
                    <section id="overview" class="hero">
                        <div class="container">
                            <h1 class="display-4 fw-bold">Electronics and Communication</h1>
